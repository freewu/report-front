...
<div style="border:1px solid blue;padding:24px;position:fixed;bottom:30%;right:0;background-color:#f3ebeb;">
	<p><a href="demo/">查看Demo</a> <br />
	<a href="#intro">项目说明</a> <br />
	<a href="#compat">兼容支持</a> <br />
	<a href="#normal">例图</a> <br />
	<a href="#trend">趋势图</a> <br />
	<a href="#table">表格</a> <br />
	<a href="#require">项目组件</a><br />
	<a href="#update">更新说明</a><br />
